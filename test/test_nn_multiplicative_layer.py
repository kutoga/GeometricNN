...
@pytest.mark.parametrize('weights, bias, input, previous, expected_output', [
    (np.array([[1., 2., 3.]]), np.array([5.]), np.array([1., 2., 1.]), np.array([1.]), np.array([1., 1., 1.])),
    (np.array([[1., 2., 3.]]), np.array([1.]), np.array([1., 2., 1.]), np.array([np.exp(1.)]), np.array([1., 2.**12., 3.**12.])),
    (np.array([[1., 2., 3.]]), np.array([2.]), np.array([1., 2., 1.]), np.array([np.exp(1.)]), np.array([1., 2.**24., 3.**24.])),
])
